...
import com.ozawa.hextcgdeckbuilder.UI.splashscreen.SplashActivity;
...
public class ExpansionDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    20, // the version of the APK that the file was uploaded
                       // against
                    33197306L // the length of the file in bytes
            )
            /*new XAPKFile(
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (XAPKFile xf : xAPKS) {
                    ...
                    if (!Helpers.doesFileExist(ExpansionDownloaderActivity.this, fileName,
                            xf.mFileSize, false))
                        return false;
                    fileName = Helpers
                            .generateSaveFileName(ExpansionDownloaderActivity.this, fileName);
                    ZipResourceFile zrf;
    ...
    private void initializeDownloadUI() {
        ...
        setContentView(R.layout.expansion_downloader_activity);
