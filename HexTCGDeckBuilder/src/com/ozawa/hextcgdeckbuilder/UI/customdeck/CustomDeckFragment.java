...
public class CustomDeckFragment extends Fragment implements FilterDrawerFragment.NavigationDrawerCallbacks,
	...
	/**
	 * Set up the data required for gesture input
	 */
	...
	/**
	 * The animation arguments for removing cards from the deck
	 * 
	 * @param x
	 * @param y
	 * @return a HexUil.AnimationArg object with the given parameters for the
	 *         animation
	 */
	...
	/**
	 * Create the dialog to remove multiple cards from the deck
	 * 
	 * @param position
	 * @param values
	 * @return true if the dialog is created, otherwise false
	 */
	...
	/**
	 * Set if the view is in gridview
	 * 
	 * @param isGridView
	 */
	...
	/**
	 * Reload the custom deck fragment
	 * 
	 * @param reloadFullView
	 *            - reload all cards in the view
	 * @param position
	 *            - the position of a card to reload
	 */
	...
	/**
	 * Reload the custom deck view
	 */
	private void reloadCustomDeckView() {
	...
	/**
	 * Set the visibilty of the buttons for the custom deck menu
	 */
	 ...
	 * 
	 * @param position
	 *            - the position of the card in the custom deck list
	 */
	...
	public boolean saveNewDeck(String deckName) {
		if (customDeck.saveNewDeck(deckName, true) != null) {
